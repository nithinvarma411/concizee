    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          `}
          >
            Your intelligent AI companion for meaningful conversations and
            instant assistance
          </p>
          ...
          {isAuthenticated ? (
                ...
                {[
                  {
                    ...
                    description:
                      "Engage in intelligent discussions with advanced AI",
                  },
                  {
                    icon: FaRocket,
            ...
            <div className="space-y-8">
              ...
              {/* Login Prompt - visible only on mobile/tablet */}
              <div
                className={`block lg:hidden p-6 sm:p-8 rounded-xl max-w-md mx-auto ${
                ...
                {[
                  {
                    ...
                    description:
                      "Chat with advanced AI for help, learning, and creativity",
                  },
                  {
                    icon: FaRocket,
                    title: "Instant Responses",
                    description:
                      "Get immediate, intelligent answers to your questions",
                  },
                  {
                    icon: FaUsers,
                    title: "Personal Assistant",
                    description:
                      "Your AI companion for daily tasks and problem-solving",
                  },
                ].map((feature, index) => (
                  <div
                    key={index}
